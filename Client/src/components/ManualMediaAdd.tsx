...
interface ManualMediaAddProps {
  onAddMedia: () => void;
}

const ManualMediaAdd: React.FC<ManualMediaAddProps> = ({ onAddMedia }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post(
        'http://localhost:8000/media/add-manual',
        { 
          title, 
